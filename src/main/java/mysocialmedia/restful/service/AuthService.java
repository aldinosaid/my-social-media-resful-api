...
import mysocialmedia.restful.model.LoginUserRequest;
import mysocialmedia.restful.model.TokenResponse;
...
public class AuthService {
    ...
    public TokenResponse login(LoginUserRequest request) {
        ...
        User user = userRepository.findFisrtByUsername(request.getUsername())
